...
/// @file sbmv.h Performs banded real symmetric matrix-vector multiplication.
...
namespace latl
{
   /// @brief Performs banded real symmetric matrix-vector multiplication.
   /// 
   /// For a banded real symmetric matrix A, real vectors x and y, and real scalars alpha and beta,
   ///
   ///        y := alpha * A * x + beta * y
   ///
   /// is computed.  
   ...
   /// @param A Pointer to banded real symmetric n-by-n matrix A.  The bands of A are stored as rows,
