...
//
//  Created by Stephanie Patterson on 7/2/12.
...
/// @file gbtf2.h Computes an LU factorization of an m-by-n band matrix using partial pivoting with row interchanges.
