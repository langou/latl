...
namespace LATL
{
   ...
   /// interchanges and the block structure of D as determined by LATL::GETRF.
   /// @param nb Block size.
   /// @ingroup COMP

   template <typename real_t>
   int_t GETRI(int_t n, real_t *A, int_t ldA, int_t *ipiv, int_t nb)
   {
   ...
   template< typename real_t >
   int_t GETRI(int_t n, complex<real_t> *A, int_t ldA, int_t *ipiv, int_t nb)
   {
